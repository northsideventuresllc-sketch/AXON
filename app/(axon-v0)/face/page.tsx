 ...
 *
 * Spec: docs/the-face/SPEC.md. This page is the hero only: the orb, the corner reticles and
 * the state readout. Stat cards, the module list and the voice bar are steps 2 and 3.
 *
