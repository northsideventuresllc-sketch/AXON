export const BOT_COMMANDS = [
  ...
  { command: 'reject', description: 'Remove a lead from the pipeline (optional reason)' },
...
export function welcomeMessage() {
  return [
    ...
    '/reject <id> [reason] — pass on a lead (reason feeds learn loop)',
...
export function statusMessage(summary, contentSummary = null) {
  ...
  if (total === 0) {
    lines.push('', 'No drafts yet. The outreach run happens nightly, or you can trigger it manually.');
  } else if (pending > 0) {
  ...
  if (total > 0) {
    ...
    if (other > 0) {
      lines.push('', `The rest — ${other} — are already sent, replied to, or passed on.`);
    }
  }
