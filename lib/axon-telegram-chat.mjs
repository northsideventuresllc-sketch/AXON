...
- If the answer is not in CONTEXT or the chat history, reply exactly: "I don't have that in front of me" — then name where it lives in plain words. Nothing more.
