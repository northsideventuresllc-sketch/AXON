 ...
 * Output hands off to the AXON Executive Agent via agent_bus (needs_answer=true).
 *
 ...
 * caller to hand off to the AXON Executive Agent and post a Telegram alert
...
/** Build the agent_bus body handed to the AXON Executive Agent. */
