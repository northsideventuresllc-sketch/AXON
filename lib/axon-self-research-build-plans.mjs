 ...
 */
async function synthesizeArea({ area, sources, jspaceContext, supabaseKey, generate = generateViaRouter }) {
...
export async function runThreeAreaResearch({
  ...
  for (const area of THREE_AREAS) {
    ...
    const result = await synthesizeArea({ area, sources, jspaceContext, supabaseKey });
