 ...
 *   1. externalSearch() — web search with fallback (lib/web-search.mjs), same
 *      door already used and confirmed working in the retired outreach entrypoint /
 ...
 *      -> Anthropic last). If web search returns nothing, or the whole chain is
