...
/**
 * Exported so other consumers (lib/axon-agent-bus-high-stakes.mjs) can reuse the
 * exact same merge/deploy signal fireAgent() already gates authority on, instead
 * of re-typing the regex — AX-SMALL-BUILDS-BUNDLE-0904 item 2.
 */
export function isMergeDeployAction(task = '') {
  return MERGE_DEPLOY_RE.test(task);
}
